...
#電圧データ全体から単一波を返す関数
def get_oneWave(originalData: pd.DataFrame, allWaves_plot=False, oneWave_plot=False, fileName="onWave_plot") -> OneCycleData:
    ...
    if oneWave_plot:
        ...
        figure_one.savefig(f"/Users/inayoshikoya/Documents/個人的勉強/SpringBoot3/SpringBoot3プログラミング入門/singlewave/src/main/resources/output.png")
        #plt.close()
        #plt.close()
    #最適な単一波を返す
...
if __name__ == "__main__":
    ...
    get_oneWave(csv, allWaves_plot=False, oneWave_plot=True).get_data().to_csv("/Users/inayoshikoya/Documents/個人的勉強/SpringBoot3/SpringBoot3プログラミング入門/singlewave/src/main/resources/output.csv")
